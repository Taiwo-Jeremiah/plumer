!(function (e) {
  ...
  if (
    ...
    e(".themeholy-menu-wrapper").themeholymobilemenu(),
  ...
  e("[data-bg-src]").length > 0 &&
    ...
    e("[data-ani]").each(function () {
      ...
      e(this).addClass(t),
        e(".slick-current [data-ani]").addClass("themeholy-animated");
    }),
    e(".themeholy-carousel").on("afterChange", function (t, s, a, o) {
      e(s.$slides).find("[data-ani]").removeClass("themeholy-animated"),
        e(s.$slides[a]).find("[data-ani]").addClass("themeholy-animated");
    });
  var n,
    i,
    r,
    ...
    e(".pstep-1").hover(
      function () {
        e(".step-1").addClass("active"),
          e(".step-2, .step-3").removeClass("active");
      },
      function () {
        e(".step-1, .step-3").removeClass("active"),
    ...
    e(".pstep-3").hover(
      function () {
        e(".step-3").addClass("active"),
          e(".step-2, .step-1").removeClass("active");
      },
      function () {
        e(".step-2, .step-3").removeClass("active"),
          e(".step-2").addClass("active");
